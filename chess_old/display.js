...
var P4WN_PROMOTION_STRINGS = ['ферзя', 'ладью', 'коня', 'слона'];
...
var P4WN_CONTROLS = [
    {/*white player */
        ...
        refresh: function(el){
			...
			var s_ru = (s == 'human') ? 'человек' : 'компьютер';
            el.innerHTML = 'Белые: <b>' + s_ru + '</b>';
        }
    },
    {/*black player */
        onclick_wrap: function(p4d){
    ...
    {/*swap sides */
        ...
        refresh: function(el){
            if (this.players[0] != this.players[1])
                el.innerHTML = ', <b>поменяться</b>';
            else
                el.innerHTML = ', поменяться';
        }
    },
    {/* undo*/
        onclick_wrap: function(p4d){
    ...
    {/* pawn promotion*/
        onclick_wrap: function(p4d){
            return function(e){
                ...
                p4d.pawn_becomes = x;
                _event_target(e).innerHTML = ', пешка превращается в <b>' + P4WN_PROMOTION_STRINGS[x] + '</b>';
            };
        },
        refresh: function(el){
            el.innerHTML = ', пешка превращается в <b>' + P4WN_PROMOTION_STRINGS[this.pawn_becomes] + '</b>';
        }
    },
    {/*computer level*/
        onclick_wrap: function(p4d){
            return function(e){
                ...
                _event_target(e).innerHTML = ', уровень компьютера: <b>' + P4WN_LEVELS[x] + '</b>';
            };
        },
        refresh: function(el){
            el.innerHTML = ', уровень компьютера: <b>' + P4WN_LEVELS[this.computer_level] + '</b>';
        }
    },
